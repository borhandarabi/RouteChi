...
// #1731v2 guard: a provider circuit-breaker-open response (503 + `X-RouteChi-Provider-Breaker`
// header / `provider_circuit_open` error code, see providerCircuitOpenResponse) is an RouteChi
