...
1. Download the latest `.dmg` from the [Releases](https://github.com/borhandarabi/routechi/releases) page.
2. Open the `.dmg` file.
...
1. Download `OmniRoute.Setup.*.exe` from [Releases](https://github.com/borhandarabi/routechi/releases).
2. Run the installer.
3. Launch from Start Menu or Desktop shortcut.

**Portable (No Installation):**
1. Download `OmniRoute.exe` from [Releases](https://github.com/borhandarabi/routechi/releases).
2. Run directly from any folder.

### Linux

1. Download the `.AppImage` from [Releases](https://github.com/borhandarabi/routechi/releases).
