      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-8 mb-16">
          ...
          <div className="col-span-2 lg:col-span-2">
            ...
            <div className="flex gap-4">
              <a
                ...
                href="https://github.com/borhandarabi/routechi"
                target="_blank"
          ...
          <div className="flex flex-col gap-4">
            ...
            <a
              className="text-gray-400 hover:text-[#E54D5E] text-sm transition-colors"
              href="https://github.com/borhandarabi/routechi/releases"
              target="_blank"
              rel="noopener noreferrer"
            >
              {t("changelog")}
          ...
          <div className="flex flex-col gap-4">
            ...
            <a
              className="text-gray-400 hover:text-[#E54D5E] text-sm transition-colors"
              href="https://github.com/borhandarabi/routechi/blob/main/LICENSE"
              target="_blank"
              rel="noopener noreferrer"
            >
              {t("mitLicense")}
