...
# روی یک RouteChi راه دور (پس از `omniroute connect <host>`، این کار خودکار است)
...
omniroute launch --profile glm52  # Claude Code با استفاده از glm/glm-5.2 از طریق RouteChi
```
