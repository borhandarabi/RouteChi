...
RouteChi می‌تواند به‌عنوان یک سرور headless روی اندروید از طریق Termux اجرا شود. برنامهٔ
...
> **نسخهٔ Node.js:** RouteChi نیازمند Node `>=22.22.2 <23 || >=24.0.0 <27` است (با `engines`
...
RouteChi را در حالت سرور headless راه‌اندازی کنید:
...
تلفن و کلاینت را روی همان شبکهٔ قابل‌اعتماد نگه دارید. اگر RouteChi را خارج از تلفن
نمایان می‌کنید، کلیدهای API و احراز هویت داشبورد را فعال کنید.

## شاخهٔ داده

به‌طور پیش‌فرض RouteChi داده‌ها را تحت شاخهٔ home مربوط به Termux ذخیره می‌کند و از همان
