---
title: "RouteChi Architecture"
version: 3.8.40
lastUpdated: 2026-06-28
---

# RouteChi Architecture
...
RouteChi is a local AI routing gateway and dashboard built on Next.js.
...
RouteChi can install, supervise, and route to locally-running AI tool processes
...
- RouteChi response metadata builder: `src/domain/omnirouteResponseMeta.ts`
...
> RouteChi v3.8.0. For the canonical and continuously-updated list, refer to
...
- final client response returned by RouteChi; streamed responses are stored in the same compact summary form
